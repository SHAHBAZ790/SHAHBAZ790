...
\033[1;91m☞ Auther     : SHAHBAZ.DASTI

\033[1;92m☞ WhatsApp   : 03464496325

\033[1;95m☞ Gmail    : shahbazdasti10@gmail.com
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Syed_Ali Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' Syed_Ali WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/Syedali')

	    os.system('cd $HOME && git clone https://github.com/SyedAliCrack/Syedali')
	    ...
	    psb('WhatsApp Num +12262414596✓')

	    psb('WellCome To SYED-ALI')

	    psb('Congratulations B4_BALOCH Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ SYEDALI✓')

	    psb('🔓Password ☆ SYEDALI✓')

	    psb('Subscrib My Youtube Channel hehehe M4 MASTER✓')
